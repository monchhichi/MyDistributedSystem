...
conn1.request("POST", "/api/v1/get_neighbors", '{ "node_id": 100 }', headers)
r = conn1.getresponse()
print r.read()
print r.status, r.reason

conn2.request("POST", "/api/v1/get_neighbors", '{ "node_id": 111 }', headers)
r = conn2.getresponse()
print r.read()
print r.status, r.reason

conn1.request("POST", "/api/v1/get_neighbors", '{ "node_id": 112 }', headers)
r = conn1.getresponse()
print r.read()
print r.status, r.reason
...
conn1.request("POST", "/api/v1/get_edge", '{ "node_a_id": 100, "node_b_id": 111 }', headers)
r = conn1.getresponse()
print r.read()
print r.status, r.reason

conn2.request("POST", "/api/v1/get_edge", '{ "node_a_id": 100, "node_b_id": 101 }', headers)
r = conn2.getresponse()
print r.read()
print r.status, r.reason
